                ...
                <div className="window active">
                    ...
                    <div className="window-body has-space body-file-explorer">
                        ...
                        <div data-aos="zoom-in">
                            <SlSocialGithub className="explorer-icons m-auto" /><span>github.ico</span>
                        </div>
                        <div data-aos="zoom-in">
                            <SlSocialLinkedin className="explorer-icons m-auto" /><span>linkedin.ico</span>
                        </div>
                        <div data-aos="zoom-in">
                            <SlDoc className="explorer-icons m-auto" /><span>curriculum.doc</span>
                        </div>
                    </div>
                </div>
