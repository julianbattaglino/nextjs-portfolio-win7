                ...
                <div className="window active">
                    ...
                    <div className="window-body has-space">
                        <div className="intro-container">
                            <h1 className="main-title pt-5"><span class="underline-nice">Julian Battaglino</span></h1>
                            ...
                            <img className="profile-img" src="/julian-battaglino-pic.webp" alt="Julian Battaglino - Front End Developer. Azul, Buenos Aires, Argentina. " />
                            <p className="text-center">julian-battaglino.jpg</p>
                        </div>
